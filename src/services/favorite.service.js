// Gestion des favoris produits (MongoDB)
const { getDb } = require('../config/mongodb');
const { ConflictError, NotFoundError } = require('../utils/errors');

// Retourne la collection MongoDB favorites.
function col() {
  return getDb().collection('favorites');
}

// Liste paginée des favoris actifs d'un utilisateur.
...
// Ajoute une annonce aux favoris ; restaure un favori soft-deleted si existant.
...
// Retire une annonce des favoris (soft delete).
